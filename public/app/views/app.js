var app = angular.module('SetGame', ['ngMaterial', 'ngRoute']);

app.config(['$locationProvider', '$routeProvider', function ($locationProvider, $routeProvider) {
  $routeProvider
    .when('/', {
      templateUrl: 'app/views/board_wrapper.html',
      controller: function ($scope) {
        //This is the root scope of the Angular App
      }
    });
  ...
  .factory('SetGameFactory', function () {
    var game = {};
